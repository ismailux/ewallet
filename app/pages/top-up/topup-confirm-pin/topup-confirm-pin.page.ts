...
@Component({
  selector: 'app-topup-confirm-pin',
  templateUrl: './topup-confirm-pin.page.html',
  styleUrls: ['./topup-confirm-pin.page.scss'],
  standalone: true,
...
export class TopupConfirmPinPage implements OnInit {
